...
class RegistrationController extends AbstractController
{
    ...
    #[Route('/admin/inscription/modify/{id}', name: 'app_register_modify')]
    public function ModifyUser(User $user,Request $request, UserPasswordHasherInterface $userPasswordHasher, UserAuthenticatorInterface $userAuthenticator, UsersAuthenticator $authenticator, EntityManagerInterface $entityManager): Response
    {
